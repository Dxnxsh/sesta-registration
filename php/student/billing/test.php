...
<head>
    ...
    <script>
        ...
        // Update date and time when the modal1 is shown
        $(document).ready(function() {
            $('#blurredOverlayModal1').on('show.bs.modal', function() {
                updateDateTime();
            });
        });
...
<body style="background-image: url(../../../image/student.jpeg); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%">
    ...
    <div class="modal fade" id="blurredOverlayModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="invoice">
                        ...
                        <div class="invoice-items">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><span><?php echo $res_type1 ?></span></p>
                                        </td>
                                        <td>
                                            <p>PAYMENT FOR <span><?php echo $res_type1 ?></span></p>
                                        </td>
                                        <td>
                                            <p><span><?php echo $res_amount1 ?></span></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="invoice-total">
                            <p><b>Total Amount: </b>RM<span><?php echo $res_amount1 ?></span></p>
                ...
                <div class="modal-footer">
                    <a href="pdf_maker.php?PAYMENT_ID=<?php echo $res_id1 ?>&ACTION=VIEW" class="btn btn-success" target="_blank"><i class="fa fa-file-pdf-o"></i> View PDF</a>
                    <a href="pdf_maker.php?PAYMENT_ID=<?php echo $res_id1 ?>&ACTION=DOWNLOAD" class="btn btn-danger" target="_blank"><i class="fa fa-download"></i> Download PDF</a>
                    &nbsp;&nbsp;
                    <a href="pdf_maker.php?PAYMENT_ID=<?php echo $res_id1 ?>&ACTION=EMAIL" class="btn btn-info" onclick="downloadFile()"><i class="fa fa-envelope"></i> Email PDF</a>
                </div>
            </div>
        </div>
