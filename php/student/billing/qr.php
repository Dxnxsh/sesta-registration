  ...
  <?php include("../../config.php"); 
            ...
            while ($resultParent = mysqli_fetch_assoc($queryParent)) {
              $res_ParentMonthlyIncome = SecuritySanitizer::sanitize($resultParent['PARENT_MONTHLY_INCOME'], 'decimal');
                ...
                SecuritySanitizer::logSecurityEvent('student_qr_access', [
                    'student_id' => $res_IC,
                ...
                <div class="invoice">
                    ...
                    <div class="invoice-items">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>QR CODE : <span><?php echo $res_type1 ?></span></th>
                                </tr>
                            </thead>
                             <tbody>
                                <tr>
                    ...
                    <div class="invoice-total">
                        <p><b>Total Amount: RM </b><span><?php echo $res_amount1 ?></span></p>
                        <p><b>Discounted Total Amount: RM </b><span><?php echo $discountedIncome ?></span></p>
                    </div>
                    <div >
		                <form action="upload.php" method="POST" enctype="multipart/form-data">
			        <div class="mb-3">
				        <label for="file" class="form-label"><b>Proof of Payment</b></label>
