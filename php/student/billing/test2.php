...
<head>
    ...
    <script>
        ...
        function updateDateTime() {
            ...
            var formattedDay = currentDate.toLocaleDateString('en-US', {
                weekday: 'long',
                timeZone: 'Asia/Kuala_Lumpur'
            });
        ...
        // Update date and time when the modal2 is shown
        $(document).ready(function() {
            $('#blurredOverlayModal2').on('show.bs.modal', function() {
                updateDateTime();
            });
        });

        $(document).ready(function() {
            $('#blurredOverlayModal2').modal({
                backdrop: 'static',
                keyboard: false
            });
            ...
            $('#blurredOverlayModal2').on('click', function(e) {
                if (e.target === this) {
            ...
            $('#blurredOverlayModal2').on('hidden.bs.modal', function() {
                window.location.href = 'billing.php';
            });
        });
    </script>
    ...
    <div class="container" id="blur">
        ...
        while ($resultParent = mysqli_fetch_assoc($queryParent)) {
            ...
            if ($res_ParentMonthlyIncome < 1000) {
                // Apply a 20% discount
                $discountedIncome = $res_amount2 * 0.8;
            } else {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="invoice">
                        ...
                        <div class="invoice-items">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><span><?php echo $res_type2 ?></span></p>
                                        </td>
                                        <td>
                                            <p>PAYMENT FOR <span><?php echo $res_type2 ?></span></p>
                                        </td>
                                        <td>
                                            <p><span><?php echo $res_amount2 ?></span></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="invoice-total">
                            <p><b>Total Amount: </b>RM<span><?php echo $res_amount2 ?></span></p>
                ...
                <div class="modal-footer">
                    <a href="pdf_maker2.php?PAYMENT_ID=<?php echo $res_id2 ?>&ACTION=VIEW" class="btn btn-success" target="_blank"><i class="fa fa-file-pdf-o"></i> View PDF</a>
                    <a href="pdf_maker2.php?PAYMENT_ID=<?php echo $res_id2 ?>&ACTION=DOWNLOAD" class="btn btn-danger" target="_blank"><i class="fa fa-download"></i> Download PDF</a>
                    &nbsp;&nbsp;
                    <a href="pdf_maker2.php?PAYMENT_ID=<?php echo $res_id2 ?>&ACTION=EMAIL" class="btn btn-info" onclick="downloadFile()"><i class="fa fa-envelope"></i> Email PDF</a>
                </div>
            </div>
        </div>
