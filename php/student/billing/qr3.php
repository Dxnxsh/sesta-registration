  ...
  <?php include("../../config.php"); 
            ...
            while ($resultParent = mysqli_fetch_assoc($queryParent)) {
              $res_ParentMonthlyIncome = SecuritySanitizer::sanitize($resultParent['PARENT_MONTHLY_INCOME'], 'decimal');
                ...
                SecuritySanitizer::logSecurityEvent('student_qr3_access', [
                    'student_id' => $res_IC,
                    'payment_type' => 'PIBG FEES',
                    'amount' => $res_amount3 ?? 0
                ]);
          }
 ?>     
</div>
                ...
                <div class="invoice">
                    ...
                    <div class="invoice-items">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>QR CODE : <span><?php echo $res_type3 ?></span></th>
                                </tr>
                            </thead>
                             <tbody>
                                <tr>
                    ...
                    <div class="invoice-total">
                        <p><b>Total Amount: RM </b><span><?php echo $res_amount3 ?></span></p>
